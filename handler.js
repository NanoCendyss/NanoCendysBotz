...
module.exports = {
  async handler(chatUpdate) {
    ...
    esteh: 0,
      ...
      if (blockList.includes(m.sender)) return // Pengguna yang Diblokir Tidak Bisa Menggunakan Botz
...
"headerType": "DOCUMENT", "documentMessage": {
            ...
            "fileName": 'Creαted by : Nano Cendys ♡',
  ...
  }}, 'buttonsMessage', { quoted: false, contextInfo: { mentionedJid: [user], forwardingScore: 999, isForwarded: true, externalAdReply: { title: global.wm, body: action === 'add' ? 'Selamat Datang Kak!' : 'Yahh.. kok keluar :‹', description: action === 'add' ? 'Selamat Datang Kak!' : 'Yahh.. kok keluar :‹', mediaType: 2, thumbnail: action === 'add' ? wel : lea, mediaUrl: `https://m.youtube.com/shorts/XK2tVKJEHeI`}}})
      ...
      case 'demote':
        ...
        if (chat.detect) this.send2ButtonLoc(jid, banp, text, '🤖 NanoCendysBotz', 'MENU', '#menu', 'OWNER', '#owner', null, {
          contextInfo: {
...
`.trim(), 'NanoCendysвσтz', 'DISABLE DELETE', '.disable delete', {
      quoted: m.message,
      contextInfo: {
  ...
  async onCall(json) {
    ...
    await this.sendMessage(from, '[❗] Karena Anda Telpon Botz. Anda Akan Diblokir Otomatis.', MessageType.extendedText)
...
let fot = `Made by @${'13152040074'.split('@')[0]}`
  let msg = {
    rowner: '*CREATOR ONLY*',
    owner: '*OWNER ONLY*',
    mods: '*MODERATOR ONLY*',
...
▸ Contoh : #daftar ${user}.13`*/
  ...
  let des = {
    ...
    group: `\nHai, ${namae} 👋\nFitur Ini Hanya Bisa Dipakai Di Dalam Group!!`,
    private: `\nHai, ${namae} 👋\nFitur Ini Hanya Bisa Dipakai Di Chat Pribadi!!`,
    admin: `\nHai, ${namae} 👋\nFitur Ini Hanya Khusus Admin Group!!`,
    nsfw: `\nHai, ${namae} 👋\nFitur NSFW Belum Diaktifkan Di Chat Ini!!`,
...
▸ Contoh : #daftar ${user}.13`*/
  ...
  if (msg) return conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
        "listMessage": {
          ...
          "buttonText": "NanoCendysBotz",
          "listType": "SINGLE_SELECT",
          "sections": [
                            {
                                "rows": [{
                                         "title": `MY OWNER`,
                                         "description": " Owner NanoCendysBotz",
                                         "rowId": ".nowner"
                                    }, {
                                         "title": `ABOUT`,
                                         "description": " Tentang NanoCendysBotz", 
                                         "rowId": ".info"
                                    }, {
                                         "title": `LIST MENU`,
                                         "description": " Menu NanoCendysBotz",
                                         "rowId": ".menu"
                                    }, {
                                         "title": `SCRIPT`,
                                         "description": " SC NanoCendysBotz",
                                         "rowId": ".sc"
                                         }, {
                                         "title": `GROUP BOT`,
                                         "description": " NanoCendysBotz Official Group",
                                         "rowId": ".gcbot"
                       }],
                    "title": "Created By Nano Cendys ♡"
                  }
                        ], "contextInfo": 
                         { "stanzaId": m.key.id,
  ...
  unreg: `
Halo Kak ${namae} !
Yuk Daftar Dulu Karena Anda Belum Terdaftar Dalam Database Botz 🗂️
    
📮 Silahkan Klik Tombol Di Bawah, dan Pilih Umur Anda!`
}[type]
